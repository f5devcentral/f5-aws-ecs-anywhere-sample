...
#        print(tasks[0]['containers'][0]['networkBindings'])
    ...
    def describe_service(self, services):
        ...
        return all_services
    def sqs_queue(self, sqs):
        return self.sqs_client.receive_message(QueueUrl = sqs, WaitTimeSeconds=10)
...
#    print(client.sqs_queue("https://sqs.us-east-1.amazonaws.com/317124676658/erchen-ecs-cluster"))
